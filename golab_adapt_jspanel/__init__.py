...
adaptor = create_adaptor('JavaScript panels', 
                initial = {'url' : None, 'configuration' : None, 'configuration_url' : None, 'configuration_name' : None})
...
def edit(app_id):
    ...
    if request.method == 'POST':
        ...
        configuration_url = request.form['configuration_url']
        if value != data['url'] or configuration_url != data['configuration_url']:
            try:
    ...
    return render_template("jsconfig/edit.html",  
                                ...
                                configuration_url = configuration_url or '')
