...
def edit(app_id):
    ...
    if request.method == 'GET':
        ...
        if len(data) == 4:
            ...
            return render_template("edt/edit.html", app_id = app_id, n_trows = len(data), 
        ...
        if len(data) == 4:       
            ...
            return render_template("edt/edit.html", app_id = app_id, object_properties = object_properties_tabbed, system_properties = system_properties_tabbed, object_measures = object_measures_tabbed,
