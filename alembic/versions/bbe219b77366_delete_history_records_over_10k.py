...
def upgrade():
    ...
    for bundle_row in list(op.get_bind().execute(all_bundles_stmt)):
        ...
        if count_total > 10000: # Only focus on the ones with more than 10000
            print "Big bundle. Analyzing"
            print " - Data:", bundle_row, count_total
            ...
            for key in keys:
                ...
                if records_found > N:
                    print "   - Key {} has {} records".format(key, records_found)
                    ...
                    while records_found > N:
                        ...
                        print "     - Deleting {} of them... after: {}".format(cut_in, records_found)
